...
class Store(commands.Cog):
    ...
    async def shop(self, ctx):
        ...
        await ctx.reply(embed=elec_em)
        await ctx.reply(embed=weapons_em)
    ...
    async def buy(self, ctx, *, item):
        ...
        for i in elec_shop:
            ...
            if name == item:
                ...
                if user_eco[user_id]["Wallet"] >= price:
                    ...
                    await ctx.reply(embed=broke_em)
                return
        ...
        await ctx.reply(embed=not_found_em)
    ...
    async def bag(self, ctx, member: discord.Member = None):
        ...
        await ctx.reply(embed=bag_embed)
    ...
    async def sell(self, ctx, *, item):
        ...
        await ctx.reply(embed=check_em)
        ...
        try:
            ...
            await ctx.reply(embed=timeout_em)
            return
        ...
        if response.content.lower() == 'yes':
            ...
            if not item_data:
                await ctx.reply("Item not found in the shop data.")
                return
